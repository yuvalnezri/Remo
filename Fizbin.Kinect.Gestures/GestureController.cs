...
namespace Fizbin.Kinect.Gestures
{
    public class GestureController
    {
        ...
        public void AddRelativeGesture(string name, IRelativeGestureSegment[] gestureDefinition)
        {
            Gesture gesture = new RelativeGesture(name, gestureDefinition);
            gesture.GestureRecognized += OnGestureRecognized;
            this.gestures.Add(gesture);
        }

        public void AddSemiRelativeGesture(string name, ISemiRelativeGestureSegment[] gestureDefinition)
        {
            Gesture gesture = new SemiRelativeGesture(name, gestureDefinition);
            gesture.GestureRecognized += OnGestureRecognized;
            this.gestures.Add(gesture);
        }
